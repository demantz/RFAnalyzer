...
public class RtlsdrSource implements IQSourceInterface {
	...
	public RtlsdrSource(Context context, SharedPreferences preferences) {
		...
		int sampleRate = preferences.getInt(context.getString(R.string.pref_sampleRate), getMaxSampleRate());
		if (sampleRate > 2000000)    // might be the case after switching over from HackRF
			sampleRate = 2000000;
		setFrequency(frequency);
		setSampleRate(sampleRate);

		setFrequencyCorrection(Integer.parseInt(
		...
		setManualGain(preferences.getBoolean(context.getString(R.string.pref_rtlsdr_manual_gain), false));
		setAutomaticGainControl(preferences.getBoolean(context.getString(R.string.pref_rtlsdr_agc), false));
		if (isManualGain()) {
			setGain(preferences.getInt(context.getString(R.string.pref_rtlsdr_gain), 0));
			setIFGain(preferences.getInt(context.getString(R.string.pref_rtlsdr_ifGain), 0));
		}
	}
	...
	public RtlsdrSource updatePreferences(Context context, SharedPreferences preferences) {
		...
		if (frequencyCorrection != getFrequencyCorrection())
